...
const formatCards = [
  {
    ...
    description:
      "Circular tropical frame with palms, flowers, scooter & HH Goa badge.",
  },
  {
    id: "builder_id",
    title: "BUILDER ID",
    ...
    description:
      "Landscape event card with postage-stamp photo, dynamic QR & custom title.",
  },
  {
    id: "team_frame",
    title: "TEAM FRAME",
    ...
    description:
      "Landscape crew poster with central team frame, member list & quote.",
  },
];
...
function FormatSelector({ onSelect }) {
  ...
  useEffect(() => {
    setPreviews({
      pfp: "/assets/previews/pfp-preview.svg",
      builder_id: "/assets/previews/builder-preview.svg",
      team_frame: "/assets/previews/team-preview.svg",
    });
  }, []);
  ...
  return (
    <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
      <div style={{ marginBottom: "2rem" }}>
        ...
        >
          Select a format to instantly generate your official HH Goa 2026
